...
const Footer = () => {
  return (
    <footer className="bg-[#002c9b] flex justify-center items-center flex-col py-20">
      ...
      <p className="text-sm text-white mt-6 w-[90%] text-center mb-10 m-auto">
        If you are using a screen reader and are having problems using this
        website, please call 1-844-462-8299 for assistance.{" "}
      </p>
      <Image src="/logo.png" width={200} height={46} alt="logo"></Image>
    </footer>
  );
};
